...
|---|---|---|---|---|---|---|---|
| A-0001 | Para o vídeo final, a regra operacional deve ser <=5:00 apesar de o Entregável 5 mencionar “5 a 7 minutos” | E-0001,E-0013,E-0015,E-0016 | CRITICAL | MEDIUM | T017 provou duration cap; T018 mostrou que duração extrema não garante usabilidade; T019 deve produzir walkthrough paced <=300s; confirmar com organizador se houver canal | Orchestrator | CONTROLLED_DURATION_PASS_FINAL_USABILITY_OPEN |
...
| A-0008 | Documentos públicos-alvo podem ser parseados de forma confiável suficiente para demo | W002-T002/T007/T010;W003-T009;W004-T003;E-0014,E-0015,E-0016 | HIGH | MEDIUM | T014/T017 provaram raw ingest e fail-closed behavior; T018 confirmou que BCB table-role ambiguity deve permanecer bloqueada; usar success input separado na demo final | Data | SUPPORTED_DEMO_PATH_FAIL_CLOSED_PARSER_IDENTITY_UNLOCKED |
...
| RISK-0006 | Vídeo não prova funcionamento real <=5 min ou é insuficiente para avaliador | MEDIUM | CRITICAL | artifact ausente, >5 min, ou recording ilegível/rápida demais | T017 controls technical capture/duration; T018 proved usability mismatch; T019 must generate deliberately paced evaluator-facing artifact; T020 re-reviews independently | Demo | ACTIVE_CRITICAL_FINAL_DEMO_T019_T020 |
...
| RISK-0010 | Extração PDF perde tabelas/números/rodapés | MEDIUM | HIGH | source-trust baixa | role-aware source gate catches wrong-role/unit corruption; T014/T017/T018 prove fail-closed behavior; no demo bypass | Data | REDUCED_DETECTION_STRONG_PARSER_LOCK_OPEN |
...
| RISK-0016 | Fallback/demo parece conteúdo enlatado e não prova execução real | LOW-MEDIUM | HIGH | demo sem input/source/evidence path real | T017 proved real capture; T019 must expose success path clearly and exact provenance | Demo | REDUCED_REAL_CAPTURE_FINAL_COMMUNICATION_OPEN |
...
| RISK-0018 | Componentes passam isoladamente mas falham em clean combined checkout | LOW | HIGH | task-specific integration não executa em release CI | T012 clean release smoke + T017 real browser CI; T008 final gate remains | Auditor | STRONGLY_REDUCED_CLEAN_RELEASE_PASS |
...
| RISK-0021 | Mechanics proof ser confundido com provider/model-quality ou production-readiness proof | MEDIUM | CRITICAL | deterministic/CI mechanics usados em claim externo | cockpit states + T017/T018 evidence boundaries + provider harness + final T008 gate | Orchestrator | STRONGLY_REDUCED_GUARDRAILS_ACTIVE |
...
| RISK-0024 | Pacote recipient-facing parece dashboard estático e não demonstra ingestão real | LOW | HIGH | avaliador não encontra upload/input PDF/texto nem interação clara | T014 implementation + T017 direct recording; T019 updates obvious evaluator journey | UX/Data | TECHNICALLY_MITIGATED_PACKAGING_REFRESH_T019 |
| RISK-0025 | Evidência fica fragmentada ou packet/README ficam temporalmente stale | MEDIUM | HIGH | evaluator sees pre-remediation F-001/F-002/F-003/F-008 truth | T015 consolidated artifacts; T018 identified drift; T019 must refresh packet/root README against exact final video evidence | Writer/Auditor | ACTIVE_HIGH_T019 |
| RISK-0026 | Actions artifact de vídeo expira antes da avaliação/submissão | MEDIUM | HIGH | accepted artifact expires before evaluation without durable copy | T019 must persist artifact IDs/digests/expiry; copy to submission-controlled storage when horizon is known | Orchestrator/Demo | OPEN_RETENTION_GATE |
| RISK-0027 | Fail-closed BCB PDF pode parecer “produto quebrado” sem framing | HIGH | HIGH | final demo leads with SOURCE_BLOCKED state or hides why it blocked | T019 shows successful SOURCE_READY/PASS path first, then explicitly labels BCB as negative-control/safety example; T020 cold-evaluator review | Demo/UX | ACTIVE_HIGH_T019_T020 |
