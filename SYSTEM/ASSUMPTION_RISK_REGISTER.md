...
| RISK-0006 | Vídeo não prova funcionamento real <=5 min | MEDIUM | CRITICAL | demo sem execução real ou >5 min | cockpit + T011 storyboard 4:40 + T012 release smoke; gravação final ainda necessária | Demo | REDUCED_SCRIPT_READY_FINAL_VIDEO_OPEN |
...
| RISK-0018 | Componentes passam isoladamente mas falham em clean combined checkout | LOW-MEDIUM | HIGH | task-specific integration não executa em release CI | T011 criou release smoke; T012 executará explicitamente em clean CI; T008 mantém gate final | Auditor | REDUCED_T012_READY |
