...
| RISK-0006 | Vídeo não prova funcionamento real <=5 min ou é insuficiente para avaliador | LOW | CRITICAL | artifact ausente, >5 min, ilegível ou não reproduzível | T019 real paced 69.12s + T020 direct independent artifact review PASS; T021 preserva binary | Demo | STRONGLY_CONTROLLED_VIDEO_PACKAGE_PASS_RETENTION_OPEN |
...
| RISK-0025 | Evidência fica fragmentada ou packet/README ficam temporalmente stale | LOW | HIGH | evaluator sees pre-remediation truth | T019 refreshed packet/root README; T020 independently verified currency | Writer/Auditor | CONTROLLED_CURRENT_PACKAGE_REVIEWED |
| RISK-0026 | Actions artifact de vídeo expira antes da avaliação/submissão | MEDIUM | HIGH | accepted artifact expires before evaluation without durable copy | T020 confirmed expiry `2026-12-20T18:06:45Z`; T021 will persist exact binary and verify byte identity | Orchestrator/Demo | ACTIVE_T021_READY |
