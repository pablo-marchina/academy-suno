...
| PAIN-004 | PAIN | Ambiente financeiro/profissional exige rigor/auditabilidade | E-0001,E-0002,E-0005,E-0007,E-0008,E-0010,E-0013,E-0014,E-0015,E-0016,E-0017,E-0018 | — | provenance + RunStore + repair lineage + telemetry + recipient app + reviewed recording | reconstructible audit trail | app + demo + docs | INDEPENDENT_VIDEO_PACKAGE_AUDIT_PASS |
...
| REQ-021 | REQUIREMENT | README/instruções claras de reprodutibilidade | E-0001,E-0006,E-0007,E-0010,E-0011,E-0012,E-0013,E-0014,E-0017,E-0018 | — | README + evidence packet + consolidated report + capture provenance | clean reproduction + obvious evaluator start | README + docs/report | INDEPENDENT_REVIEW_SCOPE_PASS |
| REQ-022 | REQUIREMENT | Vídeo comprova código/interface reais | E-0001,E-0003,E-0006,E-0008,E-0010,E-0013,E-0014,E-0015,E-0016,E-0017,E-0018 | A-0001 | recipient app + real browser capture + final paced walkthrough | exact final video independently inspected | video artifact | INDEPENDENT_VIDEO_PACKAGE_REVIEW_PASS |
| REQ-023 | REQUIREMENT | Duração vídeo: máximo seguro 5 min | E-0001,E-0003,E-0013,E-0015,E-0016,E-0017,E-0018 | A-0001 | measured MP4 + hard duration gate | independently observed `69.120000s <= 300s` | video artifact | INDEPENDENT_ACTUAL_DURATION_PASS |
...
| CRIT-001 | CRITICAL | Nenhuma média compensa perda factual/requisito eliminatório | E-0001,E-0003,E-0005,E-0007,E-0008,E-0009,E-0010,E-0013,E-0017,E-0018 | — | hard-gate precedence + explicit blind review | hard failures/gaps remain terminal/non-hidden | success scorecard | INTERNAL_VIDEO_PACKAGE_PASS_EXTERNAL_GATES_OPEN |
