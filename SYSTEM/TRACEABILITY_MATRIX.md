...
| PAIN-004 | PAIN | Ambiente financeiro/profissional exige rigor/auditabilidade | E-0001,E-0002,E-0005,E-0007,E-0008,E-0010,E-0013,E-0014,E-0015 | — | provenance + RunStore + repair lineage + telemetry + recipient app + recorded evidence | reconstructible audit trail | app + demo + docs | REAL_BROWSER_AUDIT_PROOF_PASS_BLIND_VIDEO_REVIEW_PENDING |
| REQ-001 | REQUIREMENT | Ingestão de documentos financeiros públicos reais em PDF/texto | E-0001,E-0004,E-0006,E-0011,E-0014,E-0015 | A-0008 | source-trust contract + role-aware parser gate + recipient ingest adapter | safe parse/source readiness + recorded real PDF path | pipeline/app/demo | RECIPIENT_RAW_INGEST_AND_REAL_PDF_DEMO_PASS |
...
| REQ-012 | REQUIREMENT | Factuality & Grounding Checker contra fonte | E-0001,E-0003,E-0005,E-0007,E-0008,E-0010,E-0013,E-0014 | — | deterministic backbone + claim HybridDecision + role-aware source gate | wrong value/role/unit cannot become PASS | evaluator/cockpit | CLEAN_E2E_HARD_GATE_PASS |
...
| REQ-014 | REQUIREMENT | Interface comparativa com métricas por nível | E-0001,E-0003,E-0006,E-0010,E-0011,E-0014,E-0015 | — | evidence cockpit + recipient app | 3×3 side-by-side + states + provenance + recorded visit | app/demo | INTERACTIVE_RECIPIENT_APP_AND_RECORDED_PATH_PASS |
...
| REQ-018 | REQUIREMENT | Dashboard exibe rastreabilidade das fontes | E-0001,E-0002,E-0005,E-0007,E-0008,E-0010,E-0011,E-0014,E-0015 | — | cockpit + recipient provenance view | source/run/job/attempt/repair lineage | app/demo | INTERACTIVE_TRACEABILITY_PASS |
...
| REQ-021 | REQUIREMENT | README/instruções claras de reprodutibilidade | E-0001,E-0006,E-0007,E-0010,E-0011,E-0012,E-0013,E-0014,E-0015 | — | README + evidence packet + consolidated report + capture provenance | clean reproduction pass | README + docs/report | CONSOLIDATED_REPRODUCIBILITY_PASS_EXTERNAL_GAPS_EXPLICIT |
| REQ-022 | REQUIREMENT | Vídeo comprova código/interface reais | E-0001,E-0003,E-0006,E-0008,E-0010,E-0013,E-0014,E-0015 | A-0001 | recipient app + real Playwright browser capture | real code/UI technical recording | video artifact | REAL_BROWSER_VIDEO_EVIDENCE_T017_FINAL_BLIND_REVIEW_PENDING_T018 |
| REQ-023 | REQUIREMENT | Duração vídeo: máximo seguro 5 min | E-0001,E-0003,E-0013,E-0015 | A-0001 | measured MP4 + hard duration gate | observed `7.200s <= 300s` | video artifact | ACTUAL_DURATION_PASS_7_200S_FINAL_DEMO_USABILITY_PENDING_T018 |
...
| PAIN-005 | PARTNER | Escalar conteúdo multi-audiência/multicanal com confiança | E-0002,E-0003,E-0005,E-0007,E-0008,E-0010,E-0011,E-0014,E-0015 | A-0002,A-0003,A-0011 | transformation + trust + repair + telemetry + recipient evidence UX | quality/time/rework/reuse proxies | partner value section | TECHNICAL_PROOF_STRONG_HUMAN_PROVIDER_PROOF_PENDING |
| CRIT-001 | CRITICAL | Nenhuma média compensa perda factual/requisito eliminatório | E-0001,E-0003,E-0005,E-0007,E-0008,E-0009,E-0010,E-0013,E-0015 | — | hard-gate precedence + explicit blind review | hard failures/gaps remain terminal/non-hidden | success scorecard | CORE_PASS_VIDEO_REVIEW_AND_EXTERNAL_GATES_OPEN |
