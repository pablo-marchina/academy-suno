...
| REQ-016 | REQUIREMENT | Suíte automatizada/reprodutível de evals | E-0001,E-0003,E-0005,E-0007,E-0008,E-0009,E-0010,E-0011 | A-0004,A-0010 | clean CI + cockpit/parser/provider/human-prep tests | regression pass | tests + relatório | STRONG_PASS_CORE_RELEASE_E2E_CI_PENDING |
...
| REQ-019 | REQUIREMENT | Relatório: matriz de confusão de níveis | E-0001,E-0003,E-0007,E-0009,E-0011 | A-0006 | frozen blind set + agreement/adjudication tooling | target→human + human→evaluator matrices | docs/report | PREPARATION_PASS_OBSERVED_MATRIX_PENDING_T005 |
| REQ-020 | REQUIREMENT | Relatório: trade-offs custo/latência | E-0001,E-0003,E-0007,E-0008,E-0009,E-0010,E-0011 | — | telemetry + provider-neutral harness + official-pricing guard | observed latency/usage/cost only | docs/report | HARNESS_PASS_REAL_PROVIDER_RUN_BLOCKED_EXTERNAL |
| REQ-021 | REQUIREMENT | README/instruções claras de reprodutibilidade | E-0001,E-0006,E-0007,E-0010,E-0011 | — | component docs + W004-T008 release packet | clean reproduction pass | README | PARTIAL_RELEASE_FANIN_PENDING |
| REQ-022 | REQUIREMENT | Vídeo comprova código/interface reais | E-0001,E-0003,E-0006,E-0008,E-0010,E-0011 | A-0001 | evidence cockpit + release proof | real code/UI shown | video | COCKPIT_BUILT_RELEASE_VIDEO_PENDING |
