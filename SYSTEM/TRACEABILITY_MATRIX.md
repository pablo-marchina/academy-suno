...
- `E-0008` — W003-T006/T007: targeted repair com fresh hard-gate re-evaluation + immutable siblings e telemetry auditável com latency/retry/repair/usage/cost semantics; ambos com Foundation Regression/System Integrity PASS.
...
| PAIN-002 | PAIN | LLM simplifica por encurtamento e perde nuances | E-0001,E-0003,E-0005,E-0007,E-0008 | A-0003 | factual backbone + claim grounding + concept floors + targeted repair | concept/anchor preservation + failure resolution | evaluator + relatório | REPAIR_CONTROL_PASS_CALIBRATION_PENDING |
...
| PAIN-004 | PAIN | Ambiente financeiro/profissional exige rigor/auditabilidade | E-0001,E-0002,E-0005,E-0007,E-0008 | — | provenance + findings + RunStore + repair lineage + telemetry | audit trail reconstructível | dashboard + docs | CORE_AUDITABLE_UI_PENDING |
...
| REQ-012 | REQUIREMENT | Factuality & Grounding Checker contra fonte | E-0001,E-0003,E-0005,E-0007,E-0008 | — | deterministic backbone + claim-level HybridDecision + post-repair fresh gates | support/contradiction/unverifiable + provenance | evaluator/dashboard | CORE_PASS_PARTIAL_SCOPE |
...
| REQ-014 | REQUIREMENT | Interface comparativa com métricas por nível | E-0001,E-0003,E-0006,E-0008 | — | B13 evidence cockpit após W003 | side-by-side + lineage + telemetry | app | BLOCKED_BY_W003_PROOF |
| REQ-015 | REQUIREMENT | GitHub com grafo funcional e contribuições consistentes | E-0001,E-0004,E-0005,E-0007,E-0008 | — | signal-aware DAG + graph/runstore + application CI | reproducibility/history | GitHub | STRONG_PASS_CORE |
| REQ-016 | REQUIREMENT | Suíte automatizada/reprodutível de evals | E-0001,E-0003,E-0005,E-0007,E-0008 | A-0004,A-0010 | combined clean CI + focused suites | regression pass | tests + relatório | STRONG_PASS_CORE |
| REQ-017 | REQUIREMENT | Auto-correção baseada em feedback numérico | E-0001,E-0003,E-0007,E-0008 | — | TargetedRepairLoop + before/after lineage + bounded stops | one controlled PASS after fresh gate re-runs; metric deltas | demo + app | CONTROLLED_PROOF_PASS |
...
| REQ-019 | REQUIREMENT | Relatório: matriz de confusão de níveis | E-0001,E-0003,E-0007 | A-0006 | gold protocol + T008 calibration | confusion matrix + macro/per-level metrics | docs/report | GOLD_PROTOCOL_PASS_CALIBRATION_READY |
| REQ-020 | REQUIREMENT | Relatório: trade-offs custo/latência | E-0001,E-0003,E-0007,E-0008 | — | telemetry.event.v1/summary.v1 + later real provider evidence | latency distributions + observed usage/cost only | docs/report | TELEMETRY_CONTRACT_PASS_REAL_COST_PENDING |
...
| PAIN-005 | PARTNER | Escalar conteúdo multi-audiência/multicanal com confiança | E-0002,E-0003,E-0005,E-0007,E-0008 | A-0002,A-0003,A-0011 | transformation + trust + targeted repair + telemetry | quality/time/rework/reuse proxies | partner value section | SUPPORTED_CORE_CALIBRATION_PENDING |
| CRIT-001 | CRITICAL | Nenhuma média compensa perda factual/requisito eliminatório | E-0001,E-0003,E-0005,E-0007,E-0008 | — | hard-gate precedence + HybridDecision + fresh post-repair gate execution | zero critical violations | success scorecard | CORE_PASS_MUST_PRESERVE |
