...
Objetivo: reduzir os unknowns que mais ameaçam sucesso.
...
- [ ] benchmarks/counterfactuals relevantes mapeados
Status: `NOT_STARTED`
...
- [ ] causas/drivers identificados
- [ ] análise quantitativa/qualitativa validada
- [ ] status quo/counterfactual modelado
- [ ] traceability atualizada para insights-chave
Status: `NOT_STARTED`
...
Gate:
- [ ] alternativas relevantes inclusive simples/buy/do-nothing comparadas
- [ ] Partner Value + evaluation fit + feasibility considerados
- [ ] recomendação e trade-offs justificados
- [ ] valor incremental estimado
- [ ] assumptions críticas da recomendação explicitadas
- [ ] solução não é dominada por alternativa materialmente melhor
Status: `NOT_STARTED`
...
- [ ] owner/dependências/recursos definidos
- [ ] rollout/piloto e time-to-value definidos
- [ ] métricas/kill-pivot criteria definidos
